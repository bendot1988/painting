...
export type AreaContent = {
  areaIntro: string;
  /** HTML: multiple <p> blocks with <strong> for emphasis */
...
export const areaContentBySlug: Record<string, AreaContent> = {
  leicester: {
    ...
    localLandmark:
      '<p>From the <strong>King Richard III Visitor Centre</strong> and <strong>Leicester Cathedral</strong> in the historic core to Curve theatre and the shops around <strong>Highcross</strong>, Leicester\'s landmarks draw steady visitor traffic through streets where shopfronts and hospitality interiors need to look sharp year round.</p><p>Properties near <strong>Jubilee Square</strong> and the Magazine Gateway often sit in mixed-use terraces where external masonry and timber shopfronts benefit from planned repainting rather than patch repairs.</p><p>We work across the city centre and inner suburbs, matching finishes to busy pedestrian settings and the practical wear that comes with high footfall.</p>',
    industrialEstates:
      '<p>Leicester\'s employment land is spread across several well-known sites, including <strong>Meridian Business Park</strong> on the southern approach, <strong>Hamilton Business Park</strong>, Grove Park Industrial Estate and units along Braunstone Frith and the outer ring.</p><p><strong>Warehouse interiors</strong>, office corridors, trade counters and cladding on logistics buildings all need durable paint systems and clear programme planning so operations can continue.</p><p>We are used to working on multi-let estates where landlords schedule decoration between tenants, and on single-occupier factories that need out-of-hours spraying or rolling to avoid disrupting production.</p>',
    housingStock:
      '<p>Housing in Leicester ranges from <strong>Victorian and Edwardian terraces</strong> in Highfields and Stoneygate to inter-war semis in Knighton and Clarendon Park, post-war estates in Beaumont Leys and Braunstone, and a growing stock of city-centre apartments and student lets.</p><p>Older solid-wall homes often need <strong>breathable masonry coatings</strong> outside and careful prep on busy stairwells inside, while newer builds on the edge of the city tend toward open-plan layouts with lots of woodwork.</p><p>Landlords with HMO portfolios and family homes preparing for sale both ask for reliable, tidy crews who leave properties ready to let or live in.</p>',
    commercialContext:
    ...
    domesticContext:
      'Domestic clients across Leicester call us for full house repaints, room-by-room refreshes, landlord turnarounds and pre-sale makeovers in terraces, semis and newer estates alike. Kitchens, woodwork, doors and skirting take a lot of daily wear, and we use quality trade paints with proper preparation on walls and ceilings. Exterior work on render, pebbledash and garden joinery is common on older suburbs, while new-build owners often want a cohesive colour scheme through open-plan living spaces. Clear fixed quotes help you plan without surprise costs.',
    faqs: [
      {
  ...
  loughborough: {
    ...
    localLandmark:
      '<p>The <strong>Carillon tower</strong> in Queen\'s Park and the town hall on Cattle Market are among Loughborough\'s best-known landmarks, with regular events bringing visitors past shops and cafes that rely on smart exteriors.</p><p>The <strong>university campus</strong> and Hazlerigg Building draw students and staff through surrounding streets where rental flats and shared houses need reliable decorating between academic years.</p><p>John Taylor Bell Foundry heritage and carnival weekends on Queen\'s Park Road also concentrate footfall where gift shops and eateries plan repaints before busy periods. We paint in the town centre, around the park and in residential streets where presentation supports both tourism and everyday trade.</p>',
    industrialEstates:
      '<p>Loughborough\'s industrial capacity includes <strong>Empress Road Industrial Estate</strong>, Shelthorpe Industrial Estate and units along Garets Green Road and the A6 corridor toward Hathern.</p><p>Manufacturing floors, engineering workshops and logistics bays need <strong>hard-wearing coatings</strong>, line marking and periodic refresh of offices and canteens.</p><p>Landlords on multi-unit estates often book block painting programmes, and we are comfortable working around shift patterns, delivery slots and health and safety rules on active sites. Whether you occupy a single workshop or manage several units due for re-letting, we scope prep, products and access routes before work starts.</p>',
    housingStock:
      '<p>Typical homes include <strong>Victorian terraces and semis</strong> near the town centre, 1930s properties in areas such as Dishley and Thorpe Acre, and substantial post-war and modern estates on the edge of town.</p><p>Student houses and HMOs near the university need fast turnarounds on walls, woodwork and communal areas, while family homes on the outskirts often combine interior refreshes with <strong>exterior masonry work</strong>.</p><p>New-build developments off Epinal Way and toward Nanpantan add contemporary open-plan layouts that suit clean, modern paint schemes. Older bay-fronted semis frequently need careful prep on flaky gloss and sun-faded render, especially on south-facing elevations.</p>',
    commercialContext:
    ...
    domesticContext:
      'Homeowners in Loughborough book us for full redecorations, kitchen and woodwork updates, exterior walls and fences, and landlord refreshes in streets popular with students and families. We protect floors and furniture, work room by room where needed, and use quality paints that stand up to daily life. Clear fixed quotes make it straightforward to plan work around university lets, school holidays or a house sale. Commuters who want minimal disruption often choose phased decorating through halls and living spaces first, then bedrooms once the busy rooms are back in use.',
    faqs: [
      {
  ...
  hinckley: {
    ...
    localLandmark:
      '<p><strong>St Mary\'s Church</strong> and the Atkins Building on Lower Bond Street anchor Hinckley\'s historic core, while <strong>Castle Street</strong> and the pedestrianised centre draw shoppers past shopfronts that need regular maintenance.</p><p>The Triumph visitor experience brings motor enthusiasts through the area, supporting cafes and independents that invest in presentation.</p><p>Argents Mead and the leisure centre area also concentrate families and visitors on routes where salons, gyms and restaurants keep interiors fresh between busy seasons. We work on period properties in the town centre and on newer commercial frontage toward the A5, where visibility from the road matters for trade businesses.</p>',
    industrialEstates:
      '<p>Key employment sites include <strong>Dodwells Road Industrial Estate</strong>, Harrowbrook Industrial Estate and smaller clusters along the A5 and toward Sketchley.</p><p>Units here house automotive suppliers, logistics, manufacturing and trade wholesalers that need <strong>warehouse painting</strong>, office refreshes and periodic exterior work on cladding and yard buildings.</p><p>We understand landlord schedules on multi-let estates and can paint vacant units ready for new tenants, including roller doors, steelwork and marked walkways where safety colours are specified. Shift-friendly programmes help Hinckley factories avoid unnecessary downtime.</p>',
    housingStock:
      '<p>Hinckley\'s housing includes <strong>Victorian terraces</strong> near the town centre, 1930s semis in areas such as Sketchley and Burbage, and extensive post-war estates with bay-fronted properties and bungalows.</p><p>New-build estates on the town fringe add detached and semi-detached homes with smooth interior walls ready for modern colour schemes.</p><p>Rental stock and owner-occupied family homes both need practical, <strong>hard-wearing paint</strong> in kitchens, halls and exterior masonry, especially on pebbledash elevations that face weather off the A5 corridor.</p>',
    commercialContext:
  ...
  coalville: {
    ...
    localLandmark:
      '<p>The <strong>clock tower on Belvoir Road</strong> and the former Snibston colliery site, now part of the town\'s regeneration story, are familiar reference points for visitors and residents.</p><p>Market days and events bring footfall through the centre where shopfront condition influences whether people stop for independents rather than driving on.</p><p>Conkers Discovery Centre and National Forest links also draw families through the wider district, supporting hospitality businesses that refresh dining rooms and exteriors seasonally. We paint in the town centre and in communities such as Whitwick and Thringstone where commuters and families expect well-kept homes and local shops.</p>',
    industrialEstates:
      '<p>Coalville is surrounded by employment land including <strong>Stephenson Industrial Estate</strong>, Whitwick Business Park and units along Mantle Lane and the A511 corridor.</p><p>Factory interiors, storage buildings and site offices need <strong>durable coatings</strong> and sensible scheduling around production.</p><p>We work for occupiers and landlords refreshing units between tenants or upgrading cladding and yard buildings that face weather and daily wear. Multi-let estates often need coordinated programmes so several Coalville units return to market together without clashing access.</p>',
    housingStock:
      '<p>Much of Coalville\'s housing is <strong>inter-war and post-war semis and terraces</strong>, with bungalows and council-built estates in areas such as Greenhill and Snibston.</p><p>Newer developments on the edge of town add modern detached and semi-detached homes with open-plan ground floors.</p><p>Older properties often have pebbledash or render exteriors that benefit from <strong>breathable masonry paint</strong>, while interiors range from traditional separate rooms to updated layouts where woodwork and walls need a cohesive scheme.</p>',
    commercialContext:
  ...
  'melton-mowbray': {
    ...
    localLandmark:
      '<p><strong>St Mary\'s Church</strong> and the Melton Carnegie Museum on Thorpe End sit at the heart of a town that markets itself on heritage and local food.</p><p>Weekly markets and events fill the centre with visitors who notice tired shopfronts and faded signage backgrounds.</p><p>Properties near Burton Street and the cattle market area mix retail, professional offices and hospitality, all benefiting from periodic repainting inside and out. Ye Olde Pork Pie Shoppe and other food landmarks keep footfall high, so nearby businesses often schedule refreshes before summer and Christmas trading.</p>',
    industrialEstates:
      '<p>Employment sites around Melton include <strong>Scalford Road Industrial Estate</strong> and units on the edge of town serving food production, engineering and distribution.</p><p>These environments need <strong>washable interior coatings</strong>, tidy office areas and exterior maintenance on cladding and yard buildings.</p><p>We work with owners who need durable finishes and with landlords preparing units for new food or light industrial tenants. Melton Mowbray factories often need phased work so production lines can keep running while offices and welfare areas are painted.</p>',
    housingStock:
      '<p>Melton\'s housing stock includes <strong>stone and brick cottages</strong> in older streets, Victorian and Edwardian terraces, and larger 20th-century semis and bungalows on the town edge.</p><p>Villages such as Bottesford and Waltham add period farmhouses and village homes that need careful exterior prep on stone and brick.</p><p>Newer estates bring standard interiors ideal for modern neutral schemes, while older homes may need <strong>breathable exterior paints</strong> on solid walls that have been repainted many times.</p>',
    commercialContext:
  ...
  'market-harborough': {
    ...
    localLandmark:
      '<p>The <strong>Old Grammar School</strong> on The Square and the Symington Building recall Market Harborough\'s coaching and corset-making past, while the canal basin and St Dionysius Church add to a centre that rewards careful exterior maintenance.</p><p><strong>Conservation-area</strong> sensitivity means finish quality matters on period brick and sash windows.</p><p>We paint town centre premises and homes in streets where architectural character is part of the property\'s value, including properties near the Grade I listed church and the well-used market hall routes.</p>',
    industrialEstates:
      '<p>Beyond the historic core, <strong>Rockingham Road Industrial Estate</strong> and Welland Business Park host offices, trade units and light manufacturing that need regular interior and exterior painting.</p><p>Units along the A6 corridor toward Lubenham and the A14 link add logistics and distribution space requiring <strong>hard-wearing coatings</strong> in working areas.</p><p>Landlords often coordinate repaints between lettings to attract quality tenants, and we can schedule several Market Harborough units in sequence to reduce mobilisation costs.</p>',
    housingStock:
      '<p>Market Harborough features <strong>Georgian town houses</strong>, Victorian terraces, Edwardian semis and substantial inter-war properties, alongside newer estates at Lubenham and on the town fringe.</p><p>Village homes in Great Bowden and Foxton include period cottages with lime mortar and timber details that need sympathetic exterior products.</p><p>New-build homes tend toward open-plan living with extensive woodwork and feature walls where owners want cohesive colour flows from hall to living space.</p>',
    commercialContext:
  ...
  'oadby-wigston': {
    ...
    localLandmark:
      '<p><strong>Leicester Racecourse</strong> on Oadby\'s edge and the University of Leicester Botanic Garden in Oadby bring visitors through roads lined with shops and professional offices.</p><p>In Wigston, the Wigston Framework Knitters Museum and the town centre streets link a community that values well-kept local traders.</p><p>Businesses on <strong>The Parade</strong> in particular compete on presentation, and regular exterior painting is part of staying in step with neighbours before race meetings and term starts bring extra footfall.</p>',
    industrialEstates:
      '<p>Light industrial and trade premises sit on <strong>Bassett Street</strong> in Wigston, South Wigston industrial areas and smaller business yards off the main corridors.</p><p>These units need <strong>warehouse and office painting</strong>, roller doors and cladding refresh, and between-tenancy work for landlords.</p><p>We plan around daytime trade and residential neighbours who expect considerate working hours, and we can paint several Wigston units in one programme for agents managing multiple lettings.</p>',
    housingStock:
      '<p>Oadby and Wigston are dominated by <strong>inter-war and post-war semis</strong> and detached homes, with bungalows and some Victorian terraces closer to the old cores.</p><p>Oadby\'s south and east include larger 1960s and 1970s properties, while new apartments near the racecourse add rental stock.</p><p>Interiors often feature extensive woodwork, bay windows and rendered exteriors that need periodic maintenance, especially where south-facing bays have faded.</p>',
    commercialContext:
    ...
    domesticContext:
      'We paint family homes, flats and landlord properties across Oadby and Wigston, from single rooms to full house projects and exterior walls. Kitchens, halls and woodwork get durable finishes, and we work neatly in occupied homes. Quotes follow a phone call, photos or a site visit to discuss colours and timing, including options to decorate upstairs first while family life continues downstairs. Semis near the racecourse often need exterior render and front door woodwork refreshed together for a cohesive street appearance.',
    faqs: [
      {
  ...
  'ashby-de-la-zouch': {
    ...
    localLandmark:
      '<p><strong>Ashby Castle</strong> and the town\'s Market Street create a setting where shopfronts and hospitality venues benefit from regular repainting.</p><p>Visitors heading to Calke Abbey and National Forest sites pass local businesses that compete on kerb appeal.</p><p>Period properties on <strong>Bath Street</strong> and Station Road need careful prep on brick, render and timber, especially where businesses occupy upper floors as well as ground-floor units. The town\'s baths heritage and annual events also concentrate visitors in streets where independents refresh dining rooms and facades ahead of peak weekends.</p>',
    industrialEstates:
      '<p><strong>Brookside Industrial Estate</strong> and smaller business yards on the outskirts of Ashby house trade, logistics and manufacturing units that need warehouse interiors, office refreshes and exterior cladding maintenance.</p><p>We work for occupiers upgrading premises and for landlords between lettings.</p><p>Scheduling respects active sites and nearby residential streets, and we can combine several units into one programme when an agent has multiple vacancies due for handover.</p>',
    housingStock:
      '<p>Ashby offers a mix of <strong>Georgian and Victorian town houses</strong>, brick terraces, 20th-century semis and newer estates on the town edge.</p><p>Villages such as Blackfordby and Packington include stone and brick cottages with traditional construction.</p><p>Many homes have rendered exteriors and panel doors that need quality <strong>exterior paint systems</strong>, while interiors range from period rooms with high ceilings to modern open-plan layouts where owners want cohesive colour through halls and living spaces.</p>',
    commercialContext:
  ...
  lutterworth: {
    ...
    localLandmark:
      '<p>The <strong>Frank Whittle statue</strong> and museum connection remind visitors that Lutterworth is the birthplace of the jet engine, while St Mary\'s Church and Church Street anchor the historic centre.</p><p><strong>Rugby Road</strong> carries additional retail and automotive businesses serving pass-through traffic from the A5 and M1.</p><p>Visible frontage matters for units along these corridors, and landlords often refresh premises between tenants before new brands move in. The town\'s market and community events also bring local footfall that rewards freshly painted cafes and independents.</p>',
    industrialEstates:
      '<p><strong>Magna Park Lutterworth</strong> and surrounding logistics hubs dominate the area\'s large-scale painting needs: warehouse interiors, mezzanines, office pods, cladding and yard buildings.</p><p>Smaller trade parks and units along the M1 corridor need between-tenancy decoration and <strong>safety-conscious working at height</strong>.</p><p>We plan programmes around occupancy, handover dates and landlord specifications on new builds, including night shifts where racking and deliveries cannot be interrupted during the day.</p>',
    housingStock:
      '<p>Lutterworth\'s housing includes <strong>Georgian and Victorian properties</strong> in the town centre, 20th-century semis and bungalows, and extensive new-build estates such as Swift Way and developments toward Bitteswell.</p><p>Village homes in Kimcote and Walcote add period stone and brick cottages.</p><p>New homes often need snagging touch-ups and full interior schemes, while older stock benefits from exterior masonry and woodwork maintenance on bay-fronted semis facing busy roads.</p>',
    commercialContext:
  ...
  syston: {
    ...
    localLandmark:
      '<p><strong>St Peter and St Paul Church</strong> towers over the High Street, where local businesses rely on repeat custom from Syston residents.</p><p>The railway station links commuters to Leicester, supporting a town centre that mixes convenience retail with cafes and salons.</p><p>Properties along <strong>Barkby Road</strong> and the main commercial strip benefit from periodic repainting to stay competitive with nearby retail parks at Thurmaston and Birstall. School events and sports clubs also bring families through the centre, where refreshed shopfronts help independents stand out.</p>',
    industrialEstates:
      '<p>Light industrial units and trade premises sit on the edge of Syston near <strong>Barkby Road</strong> and toward Thurmaston, serving logistics, manufacturing and automotive trade.</p><p>These sites need <strong>warehouse and office painting</strong>, roller door refresh and landlord work between lettings.</p><p>We schedule around daytime noise limits and residential neighbours close to employment areas, and we can paint several units in sequence when an agent has multiple vacancies.</p>',
    housingStock:
      '<p>Syston has <strong>Victorian terraces</strong> near the centre, substantial inter-war and post-war semis, and newer estates on the town edge with detached and semi-detached homes.</p><p>Bungalows are common on quieter roads.</p><p>Interiors often need woodwork updates and family-friendly durable finishes, while exteriors include render, pebbledash and bay-window masonry that benefits from breathable coatings. Landlords with terraces near the station frequently book kitchen and hallway refreshes between lettings when agents need a quick re-list date.</p>',
    commercialContext:
    ...
    domesticContext:
      'We decorate homes across Syston, from terrace refreshes to full semis and new-build rooms. Landlord turnarounds, kitchen and woodwork painting, and exterior walls are everyday requests. Clear fixed quotes help families plan around work and school routines, with phased decorating when only part of a house is being updated. Terraces near the station are popular rentals where agents ask for fast kitchen and hallway turnarounds between tenants.',
    faqs: [
      {
  ...
  anstey: {
    ...
    localLandmark:
      '<p><strong>Bradgate Park</strong>, with the ruins of Bradgate House and the Old John folly, brings walkers and cyclists through Anstey, supporting pubs and visitor-facing businesses on Bradgate Road.</p><p>The village centre mixes independents and services in buildings that range from brick terraces to more modern units.</p><p>Exterior condition on the main road influences whether passers-by stop, especially at weekends when the park is busiest. Memorial events and local markets also concentrate residents on routes where cafes and shops invest in fresh interiors.</p>',
    industrialEstates:
      '<p>Smaller industrial and trade units sit off <strong>Cropston Road</strong> and on the edge of Anstey, serving local manufacturing, automotive trade and storage.</p><p>These premises need practical <strong>warehouse and office painting</strong>, yard building maintenance and landlord refreshes between tenants.</p><p>We work around daytime operations and keep neighbouring residential streets in mind, with clear daily clean-up so pavements stay safe for pedestrians. Multi-let yards often need two or three Anstey units painted in sequence when landlords prepare for new trade tenants.</p>',
    housingStock:
      '<p>Anstey\'s housing includes <strong>Victorian and Edwardian terraces</strong> near the centre, 1930s semis, post-war estates and newer infill developments.</p><p>Many properties are family homes with gardens, panel doors and rendered or pebbledash exteriors.</p><p>Rental stock near the park and main road needs quick turnarounds between tenants, with durable finishes in halls and kitchens that cope with high wear. Commuter semis off Bradgate Road often combine living room refreshes with front exterior work so the house presents well from the busy village approach.</p>',
    commercialContext:
  ...
  birstall: {
    ...
    localLandmark:
      '<p><strong>Birstall Shopping Park</strong> dominates local retail traffic, with large-format units, restaurants and leisure operators that require periodic internal and external repainting to meet brand guidelines.</p><p>The village centre along Loughborough Road and Hallam Fields Road retains independents and services in a more traditional setting.</p><p>Nearby Bosworth Country Park links heritage tourism to the wider catchment passing through Birstall, supporting pubs and cafes that refresh dining areas seasonally. Hallam Fields local centre serves everyday shopping needs where convenience stores and services maintain smart frontage beside the busier A6 corridor.</p>',
    industrialEstates:
      '<p><strong>Greengate Industrial Estate</strong>, units around Birstall Shopping Park and logistics sites along the A6 host distribution, trade and automotive businesses needing warehouse interiors, cladding refresh and office decoration.</p><p>National operators often specify colours and finishes strictly, and we work to agreed programmes including <strong>out-of-hours slots</strong>.</p><p>Landlords on multi-let sites book block refreshes between tenants so several Birstall units return to market together. Trade counters and MOT garages along the A6 often need office and workshop areas painted outside Saturday opening hours.</p>',
    housingStock:
      '<p>Birstall combines older terraces and semis near the village core with extensive post-war housing and newer estates toward Wanlip and Thurmanston.</p><p>Many homes are family occupancies with <strong>render exteriors</strong>, UPVC alongside painted timber, and busy kitchens and halls inside.</p><p>Commuter demand keeps pre-sale and refresh projects common, especially on bay-fronted semis along main roads. Newer estates toward Wanlip often need full interior schemes after purchase when developers leave neutral walls throughout.</p>',
    commercialContext:
    ...
    domesticContext:
      'Homeowners in Birstall book interior and exterior painting on semis, terraces and newer builds, including woodwork, kitchens and garden fences. We work neatly in occupied homes and provide fixed quotes. Landlord refreshes near the shopping park catchment are also common, with durable finishes in high-traffic areas. Bay-fronted semis along the A6 often need exterior masonry and front door gloss renewed together for a sharp street view. Phone, photo or site quotes help Birstall families plan colours before work starts.',
    faqs: [
      {
  ...
  blaby: {
    ...
    localLandmark:
      '<p><strong>Blaby Hall</strong> and the parish church sit among older streets that meet the busy A426 corridor, where independents and chains compete for passing trade.</p><p><strong>Everards Meadows</strong> combines brewery heritage with retail and leisure, drawing visitors who expect well-maintained buildings and signage backgrounds.</p><p>County Hall and Glenfield Hospital are close enough that professional services and healthcare-related offices add to local commercial demand, with surgeries and clinics refreshing reception areas regularly.</p>',
    industrialEstates:
      '<p><strong>Meridian Business Park</strong>, one of the East Midlands\' largest business parks, sits partly within Blaby District and generates office, warehouse and trade-counter painting across many sectors.</p><p>Smaller yards and units along the A426 and toward Enderby support logistics and manufacturing.</p><p>We paint between lettings for landlords and for occupiers upgrading fit-outs, including night programmes where daytime access is limited. Blaby town trade yards also need roller door, office and toilet refreshes when units change hands between local operators.</p>',
    housingStock:
      '<p>Blaby town has <strong>Victorian and Edwardian properties</strong>, inter-war semis and substantial post-war estates, while the wider district includes new-build estates at Lubbesthorpe and expansions toward Whetstone.</p><p>Typical homes feature rendered exteriors, bay windows and family layouts with busy kitchens and halls.</p><p>Rental stock near transport links needs efficient turnarounds with <strong>durable finishes</strong> tenants will live with daily. Whetstone and Enderby semis often need hall, stair and woodwork updates when families outgrow tired colour schemes after several years.</p>',
    commercialContext:
  ...
  glenfield: {
    ...
    localLandmark:
      '<p><strong>Glenfield Hospital</strong> is a major landmark employing thousands and drawing patients and visitors daily, with nearby businesses serving staff and families.</p><p><strong>County Hall</strong> brings office workers to the area, supporting cafes and services on Dominion Road.</p><p>Retail parks and local centres along Groby Road depend on clean, modern frontage to compete with larger destinations toward Fosse Park, and professional firms refresh receptions before client-facing meetings.</p>',
    industrialEstates:
      '<p>Business units and office parks on the western approaches, including areas off <strong>Ratby Lane</strong> and toward Kirby Muxloe, host professional services, trade counters and light industrial operators.</p><p>These need office corridors, reception areas and warehouse space painted with minimal disruption.</p><p>Healthcare and public-sector adjacent sites may require <strong>low-VOC products</strong> and strict access rules, which we discuss during quoting and reflect in method statements. Glenfield office occupiers often need evening work so daytime client meetings can continue in unaffected rooms.</p>',
    housingStock:
      '<p>Glenfield features <strong>1960s and 1970s semis</strong> and detached homes, bungalows and some inter-war properties, plus newer estates toward Anstey and Kirby Muxloe.</p><p>Many houses have render exteriors, integral garages and open-plan updates inside.</p><p>Hospital staff rentals and family homes both need reliable, tidy decorating, with durable finishes in halls and kitchens that cope with shift-work lifestyles. Pre-sale refreshes are common where owners want neutral, bright rooms before viewings on Dominion Road and Groby Road estates.</p>',
    commercialContext:
  ...
  kibworth: {
    ...
    localLandmark:
      '<p>Kibworth\'s high street, featured in national television coverage of village life, depends on well-kept shopfronts and hospitality interiors.</p><p><strong>St Wilfrid\'s Church</strong> and the Harcourt Arms area anchor community life, while the railway station links commuters to Leicester and London.</p><p>Businesses invest in exterior painting because the village brand is tied to how the centre looks, especially before summer events and busy Saturday trading. The Beauchamp and Harcourt parishes share one thriving centre where delis and boutiques compete on presentation with Market Harborough just along the A6.</p>',
    industrialEstates:
      '<p>Kibworth itself is largely residential and retail, but occupiers use small workshops and units on the parish edge, while many clients work from offices converted from village premises.</p><p>Nearby Market Harborough and Leicester business parks supply commercial work for Kibworth-based businesses.</p><p>We paint home offices, retail units and light trade premises with programmes suited to village settings, including discreet access and tidy daily clean-up. Small business owners often combine a <strong>shopfront refresh</strong> with a rear office or store room in one Kibworth quote.</p>',
    housingStock:
      '<p>Housing ranges from <strong>Georgian and Victorian village properties</strong> to 20th-century semis and substantial new-build estates on the outskirts.</p><p>Period homes may have lime mortar and sash windows; newer homes feature open-plan layouts and extensive skirting and doors.</p><p>High expectations among owners mean quality preparation and finishes matter, particularly on front rooms visible from the high street. Estate houses on the parish edge often need snagging touch-ups and full colour schemes within weeks of moving in.</p>',
    commercialContext:
  ...
  shepshed: {
    ...
    localLandmark:
      '<p>Shepshed\'s <strong>clock tower</strong> and parish church mark a centre where local traders depend on repeat custom from residents.</p><p>The town looks toward Loughborough for larger retail but retains its own identity on <strong>Field Street</strong>.</p><p>Pubs and food businesses benefit from refreshed dining areas and exteriors before busy periods, and community events bring extra footfall through streets where presentation influences whether people stop. Charnwood Road links the centre to residential estates where families use local shops weekly, so tired shopfronts stand out quickly against refreshed neighbours.</p>',
    industrialEstates:
      '<p><strong>Island Farm Industrial Estate</strong>, Charnwood Edge and other business parks around Shepshed house manufacturing, engineering and logistics units needing warehouse interiors, working areas, cladding and office refresh.</p><p>Hard-wearing coatings are common alongside standard emulsion and gloss work in offices and canteens.</p><p>We schedule around shifts and landlord handovers, with floor protection and marked access on active sites. Shepshed factories often need canteen and toilet areas painted between shift changes when production cannot stop for a full day.</p>',
    housingStock:
      '<p>Shepshed has <strong>Victorian and early 20th-century terraces</strong> near the centre, extensive post-war semis and bungalows, and newer infill housing.</p><p>Many properties are owner-occupied family homes with render exteriors and traditional layouts inside.</p><p>Rental stock is smaller than in university towns but landlord refreshes still feature, especially on terraces walking distance to Field Street. Bungalows on quiet estates often need exterior render and front door woodwork renewed together when sun exposure has faded south-facing elevations.</p>',
    commercialContext:
  ...
  'earl-shilton': {
    ...
    localLandmark:
      '<p><strong>King Edward VII Park</strong> and the town centre war memorial anchor community events that bring residents onto Wood Street and neighbouring roads.</p><p>Local churches and civic buildings frame a high street where older shopfront stock can look dated without maintenance.</p><p>Businesses that invest in repainting often see a direct impact on how welcoming the centre feels, especially where faded fascias sit next to refreshed neighbours. Weekly markets and local football clubs keep Wood Street busy, so takeaways and services refresh interiors when competition for passing trade is strongest.</p>',
    industrialEstates:
      '<p><strong>Haigh Close Industrial Estate</strong> and smaller trade yards around Earl Shilton host light manufacturing, automotive trade and storage units that need warehouse and office painting, yard buildings and between-tenancy refreshes.</p><p>Hands-on business owners value clear quotes and realistic programmes.</p><p>We work on active sites with sensible safety arrangements and can paint several units in sequence when landlords have multiple vacancies. Automotive and storage operators on Haigh Close often need yard buildings and offices refreshed before new leases start.</p>',
    housingStock:
      '<p>Earl Shilton\'s housing is largely <strong>inter-war and post-war terraces and semis</strong>, with bungalows on quieter roads and some newer estates toward Barwell.</p><p>Solid brick construction is common, often with pebbledash exteriors and traditional layouts inside.</p><p>Landlord properties and family homes both need <strong>durable finishes</strong> in kitchens and halls that stand up to daily use. Terraces off Wood Street are popular rentals where agents ask for two-week turnarounds on living rooms and woodwork before new tenants arrive.</p>',
    commercialContext:
    ...
    domesticContext:
      'Domestic clients in Earl Shilton book terrace and semi refreshes, exterior masonry painting and woodwork updates. We provide clear fixed quotes, working respectfully in occupied homes popular with local families, with room-by-room options when a full house cannot be cleared at once. Pebbledash terraces near the park often need exterior and front room work scheduled before winter weather exposes flaky render. Earl Shilton owners preparing to sell often refresh halls and woodwork first for the biggest impact on viewings.',
    faqs: [
      {
  ...
  narborough: {
    ...
    localLandmark:
      '<p>The <strong>Grand Union Canal</strong> at Narborough Basin offers a distinctive setting where pubs and businesses benefit from waterside presentation.</p><p><strong>Fosse Park</strong>, one of the UK\'s largest out-of-town retail destinations, shapes the wider area\'s economy even though it sits in Enderby parish.</p><p>Local premises along Leicester Road and the village centre rely on smart frontage to capture passing trade, and canal-side venues often refresh exteriors before summer boating traffic increases.</p>',
    industrialEstates:
      '<p><strong>Narborough Road South</strong>, the Meridian Business Park corridor and trade parks near Fosse Park host logistics, retail support, automotive and trade units needing warehouse interiors, office refresh and cladding maintenance.</p><p>Large-format retail repaints and fit-outs often need <strong>night working</strong> and strict brand colours.</p><p>We coordinate with landlords and facilities teams on multi-unit sites, providing RAMS and clear daily progress on occupied buildings. Smaller trade units in Narborough village also need office and store room refreshes when businesses expand or change use.</p>',
    housingStock:
      '<p>Narborough has expanded through <strong>modern estates</strong> with detached and semi-detached homes, alongside older village properties and bungalows.</p><p>Many new builds need full interior decoration after purchase, including woodwork and ceilings throughout.</p><p>Rental growth near Fosse Park and the railway station keeps landlord refreshes busy, with durable finishes in kitchens and halls for young professional tenants. Older village bungalows along Leicester Road often need exterior masonry and front room refreshes bundled when owners prepare to sell.</p>',
    commercialContext:
